...
public class ElementUtil {
	...
	@Step("fetching on element using locator: {0}")
	...
	public WebElement getElement(String locatorType, String locatorValue) {
		WebElement webelement = driver.findElement(getBy(locatorType, locatorValue));
	 ...
	 * @return
	 */
	@Step("waiting for element using locator: {0} and timeout is: {1}")
	 ...
	 * @param timeOut
	 */
	@Step("waiting for element  and clicking on it using locator: {0} and timeout is: {1}")
